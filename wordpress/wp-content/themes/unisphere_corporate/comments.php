...
<div id="respond">
    ...
    <h3 id="leave-a-reply" style="margin-bottom: 15px;"><?php comment_form_title( 'Leave Your Feedback', 'Leave a Reply to %s' ); ?></h3> 
	...
	<form id="comment-form" method="post" action="<?php echo get_option( 'siteurl' ); ?>/wp-comments-post.php">
        ...
        <div id="form-section-comment" class="form-section">
        	<textarea name="comment" id="comment" tabindex="4" rows="6" cols="65"></textarea>
        ...
        <div id="form-section-actions" class="form-section">
			<button name="submit" id="submit" type="submit" tabindex="5">Submit Feedback</button>
